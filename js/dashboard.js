            ...
            if (data["status"] == 200) {
                ...
                for (var i = 0; i < company_list.length; i++) {
                    ...
                    if (flag == true) {
                        ...
                        cell4.innerHTML = '<button name="buy" type="button" class="buy_button" style="margin: 0px;">Buy</button><button name="sell" type="button" class="sell_button" style="margin-left: 5px;">Sell</button>';
                        ...
                        y4.innerHTML = '<button name="buy" type="button" class="buy_button" style="margin: 0px;">Buy</button><button name="sell" type="button" class="sell_button" style="margin-left: 5px;">Sell</button>';
                    }
                }
            }
            else {
